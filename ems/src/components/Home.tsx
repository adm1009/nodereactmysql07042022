...
> {
  ...
  submitForm = async (e: any) => {
    e.preventDefault();
    await fetch(
      `https://623ae79df8827fbe47aaf15a.mockapi.io/login?search=${this.state.username}`
    ).then((data: any) => {
      data.json().then((resp: any) => {
  ...
  registerDataHandler = (e:any) => {
    ...
    this.setState({register:false,login:true,usernameReg:"",passwordReg:""})
  };
  render() {
    return (
      <div>
